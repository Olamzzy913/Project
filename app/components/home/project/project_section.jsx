...
const projects = [
  ...
  // },
  {
    id: "fundryft",
    name: "FundryFT",
    type: "STARTUP-INVESTOR MATCHING PLATFORM",
    platform: "web",
    tagline: "Where founders meet future backers",
    description:
      "Connected startup founders with angel investors and VCs through intelligent matchmaking. Manual discovery process caused 3+ weeks of deal拖延 before optimization. Built smart recommendation engine reducing time-to-connect by 78%. Implemented verified profiles and secure document sharing increasing investor trust by 45%.",
    tech: ["React", "Next.js", "Tailwind", "Nest.js"],
    metrics: {
      performance: "1.2s load",
      uptime: "99.7%",
      impact: "78% faster matching",
      users: "3.2K+ startups | 1.1K+ investors",
    },
    color: "#01E8F0",
    bg: "#162020",
    shot: "./fundryft.png",
    demo: "https://www.fundryft.com",
    appStoreUrl: null,
    playStoreUrl: null,
    github: "https://github.com/username/fundryft",
    url: "https://www.fundryft.com/",
    stats: [
      { label: "Match Speed", value: "-78%", progress: 78 },
      { label: "Deal Success", value: "+62%", progress: 88 },
      { label: "User Retention", value: "+40%", progress: 85 },
    ],
  },
];
